...
<head>
    ...
    <title>Bienvenido a TiendaModa</title>
    <style>
        ...
        /* Caja del cupón */
        .coupon-box {
            background-color: #fffbeb; /* Fondo crema suave */
            border: 2px dashed #d97706; /* Borde naranja discontinuo */
            border-radius: 12px;
            padding: 30px;
            margin: 30px 0;
            position: relative;
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="coupon-box">
                ...
                <p style="margin: 10px 0 0 0; color: #92400e; font-size: 14px;">10% de Descuento</p>
            </div>

            <a href="{{ config('app.url', 'https://tienda-moda-9nok.onrender.com') }}" class="btn">
                Ir a la Tienda
            </a>

            <div class="legal-text">
                *Condiciones: Este código es válido para un único uso por cliente.
                Requiere una <strong>compra mínima de 50€</strong>.
                No acumulable con otras ofertas.
            </div>
        </div>

        <div class="footer">
            &copy; {{ date('Y') }} TiendaModa S.L. Todos los derechos reservados.<br>
